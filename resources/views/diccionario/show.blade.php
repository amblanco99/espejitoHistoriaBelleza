  ...
  <html lang="es">
    <head>
      ...
      <style>
        ...
        .mirror-canvas {
          position: absolute;
          inset: 18% 20% 22% 20%; /* top right bottom left */
    ...
    <body class="bg-[#f8f8fa] text-[#34113F]">
      ...
      <section
        class="max-w-5xl mx-auto mt-6 grid grid-cols-12 gap-6 items-start"
      >
        ...
        <main class="col-span-8">
          ...
          <div class="flex justify-center gap-3 mt-4 text-sm">
            <button id="download" class="px-3 py-1 border rounded">
              Descargar imagen
            </button>
          </div>
        </main>
